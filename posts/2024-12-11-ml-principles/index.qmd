...
title: Machine Learning is Evaluation All the Way Down
---
...
[![A tower of turtles (photo CC-BY-NC-SA 2.0 Dan Machold)](mybloodyself_turtles.jpg){fig-alt="Three turtles stacked up" fig-align="center" width="400"}](https://www.flickr.com/photos/mybloodyself/1108834349/)
...
And the top turtle, or the inner loop of training, is the opposite. It can be a simplistic objective function evaluated on out-of-domain data. You can get a model to do something useful for you with a pretty large departure from the extrinsic data and objective. A spam filter can block new kinds of spam that were not available for training, just by generalizing from simplistic representations of email. And fundamentally, LLMs start their development evaluating predictions of the next few characters in text corpora that might or might not contain examples of the genre of text that your system is generating.

[![A turtle on a turtle pile, evaluating his life choices (photo CC-BY 2.0 Marco Verch)](turtle_on_stone.jpg){fig-alt="One small turtle on top of various other turtles" fig-align="center" width="400"}](https://foto.wuestenigel.com/turtle-on-a-stone/)
...
[![Two turtle piles (photo CC-BY-ND-2.0 Nick Harris)](nickharris1_turtle_pileup.jpg){fig-alt="Two stacks of two turtles each" fig-align="center" width="400"}](https://flickr.com/photos/nickharris1/4858787832)
