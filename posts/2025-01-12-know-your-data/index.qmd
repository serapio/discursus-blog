...
[![Moray jaws open wide (image CC-BY Zina Deretsky and Ryan Wilson)](moray-jaws.png){fig-alt="pharyngeal jaws of moray eels" fig-align="left" width="512"}](https://en.wikipedia.org/wiki/File:Pharyngeal_jaws_of_moray_eels.svg)

## That's a moray

As an anonymous poet[^1] has said:

[^1]: If you know the origin, please let me know. I have not been able to trace its source beyond instagram copypasta circa 2000.
...
![A moray shows its big front teeth (image mine, CC-BY-4.0)](big-teeth.gif){fig-alt="Moray peaks out of a hole, slightly opening its mouth" fig-align="left" width="256"}
...
![With big stretch, a moray shows its whole body and maw (image mine, CC-BY-4.0)](big-yawn.gif){fig-alt="Moray in crevasse opens its mouth wide" fig-align="left" width="512"}
...
![A moray keeps itself hidden (image mine, CC-BY-4.0)](hiding.gif){fig-alt="A moray peaks its head out from a hole, with coral and fish around it" fig-align="left" width="256"}
...
![A moray reveals its whole body, and shows a fish all its teeth (image mine, CC-BY-4.0)](big-reveal.gif){fig-alt="A moray grabs a dead fish and pulls it back towards its hole" fig-align="left"}